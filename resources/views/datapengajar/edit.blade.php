    ...
    <div class="container">
        <div class="card shadow rounded">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0">Edit Data Pengajar</h4>
            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_pengajar" class="form-control"
                                value="{{ $pengajar->nama_pengajar }}" required>
                        </div>
                        <div class="col-md-6">
                            <label for="jenis_kelamin" class="form-label">Jenis Kelamin</label>
                            <select name="jenis_kelamin" class="form-control" required>
                                <option value="Laki-Laki" {{ $pengajar->jenis_kelamin == 'Laki-Laki' ? 'selected' : '' }}>
                                    Laki-laki</option>
                                <option value="Perempuan" {{ $pengajar->jenis_kelamin == 'Perempuan' ? 'selected' : '' }}>
                                    Perempuan</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="tempat_lahir" class="form-control"
                                value="{{ $pengajar->tempat_lahir }}" required>
                        </div>
                        <div class="col-md-6">
                            <label for="tanggal_lahir" class="form-label">Tanggal Lahir</label>
                            <input type="date" name="tanggal_lahir" class="form-control"
                                value="{{ $pengajar->tanggal_lahir }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="pendidikan_umum" class="form-control"
                                value="{{ $pengajar->pendidikan_umum }}">
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="pendidikan_diniyah" class="form-control"
                                value="{{ $pengajar->pendidikan_diniyah }}">
                        </div>
                    </div>
